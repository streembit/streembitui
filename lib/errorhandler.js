...
(function () {
    ...
    errhandler.getmsg = function (errorcode, err, param) {
        ...
        if (err) {
            ...
            if (sub_error_msg) {
                ...
                if(typeof err.changeErrMessage !== 'undefined') {
                   errmsg += err.changeErrMessage + ": " + sub_error_msg;  
                }else{
    ...
    function onErrorEvent(errorcode, err, param) {
        try {
            var msg = errhandler.getmsg(errorcode, err, param);
            logger.error(msg);
        }
        catch (e) {
            logger.error("onErrorEvent %j", e);
        }
    }
    ...
    errhandler.load = function () {
        return new Promise(function (resolve, reject) {
            appevents.onError(
                (errorcode, err, param) => {
                    onErrorEvent(errorcode, err, param);
                }
            );
