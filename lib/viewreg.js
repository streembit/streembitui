...
(function () {
    ...
    viewregister.load = function () {
        return new Promise((resolve, reject) => {
            ...
            ko.components.register('filecabinets', { require: './lib/app/views/filecabinets/filecabinets' });
            ko.components.register('utilcerts', { require: './lib/app/views/utilcerts/utilcerts' });
            ko.components.register('commsecurity', { require: './lib/app/views/commsecurity/index' });
            ko.components.register('idqa', { require: './lib/app/views/idqa/myidqa' });
            ko.components.register('ndas', { require: './lib/app/views/ndas/ndacoll' });
