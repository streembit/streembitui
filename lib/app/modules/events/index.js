...
function AppEvents() {
    ...
    this.TYPES = {
        ...
        ONTRANSPORTINIT: "onTransportInit",
        ONWSMSGRECEIVE: "onWsMsgReceive",
        ONPEERSEND: "onPeerSend",
        ONNETSEND: "onNetSend",
        ONAPPNETFAILED: "onAppNetFailed",
        ONIOTHUBADDED: "onIoTHubAdded"
    };
...
AppEvents.prototype.peersend = function (contact, data, callback) {
    var payload = {
        contact: contact,
        data: data,
        callback: callback
    }
    this.emit(this.APPEVENT, this.TYPES.ONPEERSEND, payload);
}

AppEvents.prototype.netsend = function (key, value, callback) {
    var payload = {
        key: key,
        value: value,
        callback: callback
    }
    this.emit(this.APPEVENT, this.TYPES.ONNETSEND, payload);
}
