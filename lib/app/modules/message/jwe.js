...
var jwe = (function () {
    ...
    */
    ...
    obj.aes256decrypt_tobuffer = function (symmetric_key, cipher_text) {
        var buff = Buffer.from(cipher_text, 'base64');
        var decipher = aes.createDecipher('aes256', symmetric_key);
        var plain_buffer = Buffer.concat([decipher.update(buff), decipher.final()]);
