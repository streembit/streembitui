        ...
        try {
            ...
            streembit.UI.accept_call(sender, calltype, function (result) {
                ...
                if (result) {
                    ...
                    appevents.emit(appevents.TYPES.ONAPPNAVIGATE, defs.CMD_CONTACT_CALL, null, uioptions);
                }
            });
        }
        catch (e) {
        ...
        try {
            ...
            switch (data.cmd) {
                ...
                case defs.PEERMSG_CALL_WEBRTC:
                    ...
                    appevents.emit(appevents.APPEVENT, appevents.TYPES.ONCALLWEBRTCSIGNAL, data);
                    break;
    ...
    percomm.get_account_messages = function (msgkey, page, start) {
        try {
            ...
            streembit.Node.get_range(querystring, function (err, result) {
                if (err) {
                    return appevents.emit(defs.EVENT_ERROR, streembit.Error.Codes.FINDMESSAGES, err);
                }
                
                appevents.emit(appevents.APPEVENT, appevents.TYPES.ONACCOUNTMSG, result);
            });
        }
        catch (e) {
