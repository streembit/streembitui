...
var net = require('./streembitnet').default;
...
(function () {
    ...
    percomm.get_published_contact = function (account, callback) {
        net.client.get(account, function (err, msg) {
            try {
                ...
                var ecdhpk = decoded.data[peermsg.MSGFIELD.ECDHPK];
                if (!ecdhpk) {
                ...
                if (cipher && contactskeys && Array.isArray(contactskeys)) {
                    ...
                    var protocol = peermsg.MSGFIELD.PROTOCOL ? decoded.data[peermsg.MSGFIELD.PROTOCOL] : streembit.DEFS.TRANSPORT_TCP;
                    var contact = {
                        public_key: pkey,  
                        address: address, 
                        port: port, 
    ...
    function handleKeyExchange(sender, public_key, payload, msgtext) {
        try {
            ...
            var plaintext = peermsg.ecdh_decrypt(appsrvc.publickey, public_key, data);
            ...
            var jti = create_id();
            var encoded_msgbuffer = peermsg.create_symm_msg(peermsg.PEERMSG.ACCK, jti, appsrvc.privatekey, session_symmkey, data, appsrvc.username, sender);
    ...
    function handlePing(sender, payload, msgtext) {
        try {
            ...
            var data = {};
            data[peermsg.MSGFIELD.REQJTI] = payload.jti;
            data[peermsg.MSGFIELD.ECDHPK] = appsrvc.publickey;
            ...
            streembit.Contacts.update_contact_database(contact, function (err) {
                ...
                var jti = create_id();
                var encoded_msgbuffer = peermsg.create_typedmsg(peermsg.PEERMSG.PREP, jti, appsrvc.privatekey, data, appsrvc.username, sender);
                streembit.Node.peer_send(contact, encoded_msgbuffer);
    ...
    function handleShareScreenOffer(sender, payload, msgtext) {
        try {
            ...
            streembit.UI.accept_sharescreen(sender, function (result) {
                ...
                var contact = streembit.Contacts.get_contact(sender);
                var jti = create_id();
                var encoded_msgbuffer = peermsg.create_typedmsg(peermsg.PEERMSG.RSSC, jti, appsrvc.privatekey, data, appsrvc.username, sender);
                streembit.Node.peer_send(contact, encoded_msgbuffer);
    ...
    function handleCall(sender, payload, msgtext) {
        try {
            ...
            streembit.UI.accept_call(sender, calltype, function (result) {
                ...
                var contact = streembit.Contacts.get_contact(sender);
                var jti = create_id();
                var encoded_msgbuffer = peermsg.create_typedmsg(peermsg.PEERMSG.CREP, jti, appsrvc.privatekey, data, appsrvc.username, sender);
                streembit.Node.peer_send(contact, encoded_msgbuffer);
    ...
    function exchange_session_key(contact) {
        return new Promise(function (resolve, reject) {
            try {
                ...
                var cipher = peermsg.ecdh_encypt(appsrvc.publickey, public_key, plaindata);
                
                var data = {
                    account: appsrvc.username, 
                    public_key: appsrvc.publickey,
                ...
                var jti = create_id();
                var encoded_msgbuffer = peermsg.create_typedmsg(peermsg.PEERMSG.EXCH, jti, appsrvc.privatekey, data, appsrvc.username, account);
                streembit.Node.peer_send(contact, encoded_msgbuffer);
    ...
    percomm.send_offline_message = function (contact, message, msgtype, callback) {
        try {            
            ...
            var cipher = peermsg.ecdh_encypt(appsrvc.publickey, rcpt_ecdh_public_key, plaindata);
            
            var timestamp = Date.now();
            var payload = {};
            payload.type = peermsg.MSGTYPE.OMSG;
            payload[peermsg.MSGFIELD.PUBKEY] = appsrvc.publickey;
            ...
            var jti = create_id();
            var value = peermsg.create(appsrvc.privatekey, jti, payload, null, null, appsrvc.username, null, account);
    ...
    percomm.addcontact_message = function (contact, callback) {
        try {
            ...
            payload[peermsg.MSGFIELD.MSGTYPE] = streembit.DEFS.MSG_ADDCONTACT;
            
            var hashdata = account + "/message/" + streembit.DEFS.MSG_ADDCONTACT + "/" + appsrvc.username;
    ...
    percomm.declinecontact_message = function (contact, callback) {
        try {            
            ...
            payload[peermsg.MSGFIELD.PUBKEY] = appsrvc.publickey;
            payload[peermsg.MSGFIELD.TIMES] = contact.addrequest_create || Date.now();
            payload[peermsg.MSGFIELD.MSGTYPE] = streembit.DEFS.MSG_DECLINECONTACT;
            
            var hashdata = account + "/message/" + streembit.DEFS.MSG_DECLINECONTACT + "/" + appsrvc.username;
            var jti = streembit.Message.create_hash_id(hashdata);
            var value = peermsg.create(appsrvc.privatekey, jti, payload, null, null, appsrvc.username, null, account);
            var key = account + "/message/" + jti;
            // put the message to the network
    ...
    percomm.send_peer_message = function (contact, message) {
        try {
            ...
            var jti = create_id();
            var encoded_msgbuffer = peermsg.create_symm_msg(peermsg.PEERMSG.SYMD, jti, appsrvc.privatekey, session.symmetric_key, message, appsrvc.username, account);
            streembit.Node.peer_send(contact, encoded_msgbuffer);
        }
        catch (e) {
    ...
    percomm.ping = function (contact, showprogress, timeout) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                ...
                var jti = create_id();
                var encoded_msgbuffer = peermsg.create_typedmsg(peermsg.PEERMSG.PING, jti, appsrvc.privatekey, data, appsrvc.username, account);
                streembit.Node.peer_send(contact, encoded_msgbuffer);
    ...
    percomm.send_addcontact_request = function (contact) {
        try {                
            ...
            data[peermsg.MSGFIELD.PUBKEY] = appsrvc.publickey;
            data[peermsg.MSGFIELD.PROTOCOL] = appsrvc.transport;
            data[peermsg.MSGFIELD.HOST] = appsrvc.address;
            data[peermsg.MSGFIELD.PORT] = appsrvc.port;
            data[peermsg.MSGFIELD.UTYPE] = streembit.DEFS.USER_TYPE_HUMAN;
                
            var jti = create_id();
            var encoded_msgbuffer = peermsg.create_typedmsg(peermsg.PEERMSG.ACRQ, jti, appsrvc.privatekey, data, appsrvc.username, account);
            streembit.Node.peer_send(contact, encoded_msgbuffer);
        }
        catch (err) {
    ...
    percomm.send_accept_addcontact_reply = function (contact) {
        try {
            ...
            var jti = create_id();
            var encoded_msgbuffer = peermsg.create_typedmsg(peermsg.PEERMSG.AACR, jti, appsrvc.privatekey, data, appsrvc.username, account);
            streembit.Node.peer_send(contact, encoded_msgbuffer);
        }
        catch (err) {
            streembit.notify.error("send_addcontact_request error:  %j", err);
    ...
    percomm.send_decline_addcontact_reply = function (contact) {
        try {
            ...
            var jti = create_id();
            var encoded_msgbuffer = peermsg.create_typedmsg(peermsg.PEERMSG.DACR, jti, appsrvc.privatekey, data, appsrvc.username, account);
            streembit.Node.peer_send(contact, encoded_msgbuffer);
        }
        catch (err) {
            streembit.notify.error("send_addcontact_request error:  %j", err);
    ...
    percomm.hangup_call = function (contact) {
        ...
        return new Promise(function (resolve, reject) {
            try {                
                ...
                var jti = create_id();
                var encoded_msgbuffer = peermsg.create_typedmsg(peermsg.PEERMSG.HCAL, jti, appsrvc.privatekey, data, appsrvc.username, account);
                streembit.Node.peer_send(contact, encoded_msgbuffer);
    ...
    percomm.call = function (contact, type, showprogress) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                ...
                var jti = create_id();
                var encoded_msgbuffer = peermsg.create_typedmsg(peermsg.PEERMSG.CALL, jti, appsrvc.privatekey, data, appsrvc.username, account);
                streembit.Node.peer_send(contact, encoded_msgbuffer);
    ...
    percomm.offer_sharescreen = function (contact, resolve, reject) {
        try {                
            ...
            var jti = create_id();
            var encoded_msgbuffer = peermsg.create_typedmsg(peermsg.PEERMSG.SSCA, jti, appsrvc.privatekey, data, appsrvc.username, account);
            streembit.Node.peer_send(contact, encoded_msgbuffer);
    ...
    percomm.initfile = function (contact, file, showprogress, timeout) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                ...
                var account = contact.name;
                var data = {}
                data[peermsg.MSGFIELD.CALLT] = streembit.DEFS.CALLTYPE_FILET;
                ...
                var jti = create_id();
                var encoded_msgbuffer = peermsg.create_typedmsg(peermsg.PEERMSG.FILE, jti, appsrvc.privatekey, data, appsrvc.username, account);
                streembit.Node.peer_send(contact, encoded_msgbuffer);
    ...
    percomm.get_account_messages = function (msgkey, page, start) {
        try {
    ...
    percomm.delete_message = function (msgid, callback) {
        try {            
            ...
            var jti = create_id();
            var value = peermsg.create(appsrvc.privatekey, jti, payload, null, null, appsrvc.username);
    ...
    percomm.delete_public_key = function (callback) {
        try {
            ...
            if (!appsrvc.publickey || !appsrvc.address || !appsrvc.port) {
            ...
            var value = peermsg.create(appsrvc.privatekey, create_id(), payload);
    ...
    percomm.update_public_key = function (new_public_key, callback) {
        try {
            ...
            payload[peermsg.MSGFIELD.LASTPKEY] = appsrvc.publickey;
            ...
            payload[peermsg.MSGFIELD.UTYPE] = streembit.DEFS.USER_TYPE_HUMAN;
    ...
    percomm.publish_user = function (public_key, transport, address, port, type, callback) {
        try {
            ...
            payload[peermsg.MSGFIELD.UTYPE] = type || "human";
            ...
            //  For this public key upload message the key is the device name
            net.client.put(key, value, function (err, results) {
                if (err) {
    ...
    percomm.init = function (nodeconfig) {
        return new Promise(function (resolve, reject) {
