...
streembit.PeerNet = (function (module, logger, events, config) {
    ...
    function handlePing(sender, payload, msgtext) {
        try {
            ...
            streembit.Contacts.update_contact_database(contact, function (err) {
                ...
                var jti = streembit.Message.create_id();
                var encoded_msgbuffer = wotmsg.create_typedmsg(wotmsg.PEERMSG.PREP, jti, streembit.User.private_key, data, streembit.User.name, sender);
                streembit.Node.peer_send(contact, encoded_msgbuffer);
    ...
    function handleShareScreenOffer(sender, payload, msgtext) {
        try {
            ...
            streembit.UI.accept_sharescreen(sender, function (result) {
                ...
                var contact = streembit.Contacts.get_contact(sender);
                var jti = streembit.Message.create_id();
                var encoded_msgbuffer = wotmsg.create_typedmsg(wotmsg.PEERMSG.RSSC, jti, streembit.User.private_key, data, streembit.User.name, sender);
                streembit.Node.peer_send(contact, encoded_msgbuffer);
    ...
    function handleCall(sender, payload, msgtext) {
        try {
            ...
            streembit.UI.accept_call(sender, calltype, function (result) {
                ...
                var contact = streembit.Contacts.get_contact(sender);
                var jti = streembit.Message.create_id();
                var encoded_msgbuffer = wotmsg.create_typedmsg(wotmsg.PEERMSG.CREP, jti, streembit.User.private_key, data, streembit.User.name, sender);
                streembit.Node.peer_send(contact, encoded_msgbuffer);
    ...
    function exchange_session_key(contact) {
        return new Promise(function (resolve, reject) {
            try {
                ...
                var jti = streembit.Message.create_id();
                var encoded_msgbuffer = wotmsg.create_typedmsg(wotmsg.PEERMSG.EXCH, jti, streembit.User.private_key, data, streembit.User.name, account);
                streembit.Node.peer_send(contact, encoded_msgbuffer);
    ...
    module.ping = function (contact, showprogress, timeout) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                ...
                var jti = streembit.Message.create_id();
                var encoded_msgbuffer = wotmsg.create_typedmsg(wotmsg.PEERMSG.PING, jti, streembit.User.private_key, data, streembit.User.name, account);
                streembit.Node.peer_send(contact, encoded_msgbuffer);
    ...
    module.send_addcontact_request = function (contact) {
        try {                
            ...
            var jti = streembit.Message.create_id();
            var encoded_msgbuffer = wotmsg.create_typedmsg(wotmsg.PEERMSG.ACRQ, jti, streembit.User.private_key, data, streembit.User.name, account);
            streembit.Node.peer_send(contact, encoded_msgbuffer);
        }
        catch (err) {
    ...
    module.send_accept_addcontact_reply = function (contact) {
        try {
            ...
            var jti = streembit.Message.create_id();
            var encoded_msgbuffer = wotmsg.create_typedmsg(wotmsg.PEERMSG.AACR, jti, streembit.User.private_key, data, streembit.User.name, account);
            streembit.Node.peer_send(contact, encoded_msgbuffer);
        }
        catch (err) {
            streembit.notify.error("send_addcontact_request error:  %j", err);
    ...
    module.send_decline_addcontact_reply = function (contact) {
        try {
            ...
            var jti = streembit.Message.create_id();
            var encoded_msgbuffer = wotmsg.create_typedmsg(wotmsg.PEERMSG.DACR, jti, streembit.User.private_key, data, streembit.User.name, account);
            streembit.Node.peer_send(contact, encoded_msgbuffer);
        }
        catch (err) {
            streembit.notify.error("send_addcontact_request error:  %j", err);
    ...
    module.hangup_call = function (contact) {
        ...
        return new Promise(function (resolve, reject) {
            try {                
                ...
                var jti = streembit.Message.create_id();
                var encoded_msgbuffer = wotmsg.create_typedmsg(wotmsg.PEERMSG.HCAL, jti, streembit.User.private_key, data, streembit.User.name, account);
                streembit.Node.peer_send(contact, encoded_msgbuffer);
    ...
    module.call = function (contact, type, showprogress) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                ...
                var jti = streembit.Message.create_id();
                var encoded_msgbuffer = wotmsg.create_typedmsg(wotmsg.PEERMSG.CALL, jti, streembit.User.private_key, data, streembit.User.name, account);
                streembit.Node.peer_send(contact, encoded_msgbuffer);
    ...
    module.offer_sharescreen = function (contact, resolve, reject) {
        try {                
            ...
            var jti = streembit.Message.create_id();
            var encoded_msgbuffer = wotmsg.create_typedmsg(wotmsg.PEERMSG.SSCA, jti, streembit.User.private_key, data, streembit.User.name, account);
            streembit.Node.peer_send(contact, encoded_msgbuffer);
    ...
    module.initfile = function (contact, file, showprogress, timeout) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                ...
                var jti = streembit.Message.create_id();
                var encoded_msgbuffer = wotmsg.create_typedmsg(wotmsg.PEERMSG.FILE, jti, streembit.User.private_key, data, streembit.User.name, account);
                streembit.Node.peer_send(contact, encoded_msgbuffer);
