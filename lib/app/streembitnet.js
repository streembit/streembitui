...
(function () {
    ...
    peernet.put = function (key, value, callback) {
        ...
        var put_via_ws = function (k, v, donecb) { 
            var url = 'ws://' + settings.wshost + ":" + settings.wsport + "/put";
    ...
    peernet.register_at_ws = function () {
        ...
        var url = 'ws://' + settings.wshost + ":" + settings.wsport + "/register_contact";
        var data = {
    ...
    peernet.find_contact = function (account, callback) {
        ...
        if(appsrvc.transport == defs.TRANSPORT_WS) {
            ...
            var url = 'ws://' + settings.wshost + ":" + settings.wsport + "/find_contact";
            var data = {
                "account": account
            };
