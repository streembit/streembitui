...
(function () {
    ...
    peernet.peer_send = function (contact, data) {
        function get_contact_transport(contact) {
            ...
            if (contact.protocol == defs.TRANSPORT_WS) {
                if (!peernet.wshandler) {
                    peernet.wshandler = new WsNet();
                }
                return peernet.wshandler;
            }
    ...
    peernet.put = function (key, value, callback) {
        ...
        var put_via_ws = function (k, v, donecb) { 
            var url = 'http://' + settings.wshost + ":" + settings.wsport + "/put";
    ...
    peernet.ws_put = function (key, value) {
    ...
    peernet.register_at_ws = function () {
        ...
        var url = 'http://' + settings.wshost + ":" + settings.wsport + "/register_contact";
        var data = {
    ...
    peernet.find_contact = function (account, callback) {
        ...
        var url = 'http://' + settings.wshost + ":" + settings.wsport + "/find_contact";
        var data = {
            "account": account
        };
    ...
    peernet.get_transport = function (contact_transport) {
        if (appsrvc.transport == defs.TRANSPORT_WS) {
            //  this user is using web socket, must return that and use WS
            //  in communicating with the contact
            if (!(peernet.netclient instanceof WsNet)) {
