...
var jwe = (function () {
    ...
    obj.encrypt = function(master_key, other_public_key, data) {
        if (crypto_system == obj.CRYPTOSYS.ECC) {
            var secret = create_symmetric_key(master_key, other_public_key);
    ...
    obj.decrypt = function (master_key, other_public_key, jwe_input) {
        ...
        if (header.alg.indexOf("ECDH") > -1) {
            var public_key = ec.keyFromPublic(other_public_key, 'hex');
            var secret = create_symmetric_key(master_key, public_key);
