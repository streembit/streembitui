...
(function () {
    ...
    function onRemoteStreamAdded(eventStream) {
        try {
            ...
            appevents.dispatch("on-video-connect");
        }
        catch (err) {
    ...
    webrtclib.hangup = function () {
        ...
        appevents.removeSignal("on-call-webrtc-signal", webrtclib.onSignalReceive);
    }
    ...
    webrtclib.init = function (localvideo, contactvideo, options) {
        try {
            ...
            // add event handlers
            appevents.addListener("on-call-webrtc-signal", webrtclib.onSignalReceive);
        }
        catch (err) {
