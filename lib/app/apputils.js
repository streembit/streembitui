...
(function () {
    ...
    apputils.accept_call = function (sender, type, msg = null, title = null, sound = null, resultfn) {

        if ([defs.CALLTYPE_VIDEO, defs.CALLTYPE_AUDIO, defs.CALLTYPE_CHAT].indexOf(type) < 0) {
        ...
        var audioctrl = document.getElementById(sound || 'ringsound1');
