...
(function () {
    ...
    const VALID_MSG_TYPES = [
        ...
        defs.PEERMSG_GROUPCHAT_ADD,
        defs.PEERMSG_GROUPCHAT_CONNECTION_OPEN
    ];
            ...
            try {
                ...
                switch (data.cmd) {
                    ...
                    case defs.PEERMSG_GROUPCHAT_INVITE_RESP:
                        ...
                        break;
                    case defs.PEERMSG_GROUPCHAT_ADD:
                        appevents.dispatch("oncontactevent", "on-groupchat-add", data);
                        break;
                    case defs.PEERMSG_GROUPCHAT_CONNECTION_OPEN:
                        appevents.dispatch("oncontactevent", "on-groupcall-connection-open", data);
                        break;
                    default:
