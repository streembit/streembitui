...
(function () {
    ...
    define(
        ['knockout', 'i18next', 'appevents', 'user', 'peercomm', 'appsrvc', 'definitions', 'uihandler', 'accounts', 'streembitnet', './createaccount.html!text'],
            ...
            this.submit = function () {
                ...
                try {
                    ...
                    .catch(function (err) {
                        ...
                        processed = true;
                        uihandler.unblockwin();
                        streembit.notify.error("Error in creating the account: %j", err);
                    });

                    timer = setTimeout(function () {
                        uihandler.unblockwin();
                        if (!processed) {
                            streembit.notify.error("Error in connecting to Streembit, timed out");
                        }
                    }, 30000);
