...
(function () {
    ...
    define(
        ['i18next', 'appevents', 'apputils', 'user', 'peercomm', 'appsrvc', 'definitions', 'uihandler', 'accounts', 'streembitnet', 'settings', './createaccount.html!text'],
        function (i18next, appevents, apputils, user, peercomm, appsrvc, defs, uihandler, accounts, streembitnet, settings, template) {
