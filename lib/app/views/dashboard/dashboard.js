...
(function () {
    define(['i18next', 'appevents', 'uihandler', 'contactlist', './dashboard.html!text'],
        function (i18next, appevents, uihandler, contactlist, template) {
            ...
            var viewModel = {
                ...
                iotDevices: function () {
                    if($('#left-panel').hasClass('hide-left-menu')){
                        $('.comebackToDevice').trigger('click');
                    }else{
                ...
                walletTab: function () {
                    if($('#left-panel').hasClass('hide-left-menu')){
                        $('.comebackToBlockchain').trigger('click');
                    }else{
                        $('.left-side-header-bt').trigger('click');
                        $('.comebackToBlockchain').trigger('click');
                    }
