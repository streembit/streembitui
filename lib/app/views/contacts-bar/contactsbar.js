...
(function () {
    ...
    define(
        ['knockout', 'appsrvc', 'contactlist', 'peercomm', 'appevents', 'apputils', 'streembitnet', 'settings', 'contactsutil', 'uihandler', 'utilities', './contactsbar.html!text'],
        function (ko, appsrvc, contactlist, peercomm, appevents, apputils, streembitnet, settings, contactsutil, uihandler, utilities, template) {
                ...
                onSendAddContactRequest: function () {
                    ...
                    try {
                        ...
                        var contact = {
                            ...
                            user_type: this.addcontact_obj.user_type,
                            protocol: this.addcontact_obj.account.protocol,
                            connkey: ""
                        };
