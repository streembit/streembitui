...
(function () {
    ...
    define(
        ['appsrvc', 'contactlist', 'connections', 'uuid', 'peercomm', 'appevents', 'apputils', 'secure-random', 'settings', 'definitions', 'peermsg', 'contactsutil', 'uihandler', 'utilities', 'groupcall', './contactsbar.html!text'],
        function (appsrvc, contactlist, connections, uuid, peercomm, appevents, apputils, secrand, settings, defs, peermsg, contactsutil, uihandler, utilities, groupcall, template) {
                    ...
                    onContactEvent: function (event, payload, param, data) {
                        switch (event) {
                            ...
                            case "on-text-message":
                                ...
                                break;
                            // probably move to media control module
                            case "on-invite-message":
                                groupcall.inviteIn(payload);
                                break;
                            case "on-invite-message-resp":
                                groupcall.inviteResp(payload);
                                break;
                            case "on-groupcall-connection-open":
                                groupcall.onConnectionOpen(payload);
                                break;
                            case "on-groupcall-add":
                                groupcall.initcall(payload);
                                break;
                            case "on-groupcall-ready":
                                groupcall.readycall(payload);
                                break;
                            // END probably move to media control module
