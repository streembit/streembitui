        ...
        function ContactsListVm() {
            ...
            var viewModel = {
                ...
                dispose: function () {
                    ...
                    appevents.removeSignal("on-remove-contact", this.remove_byname);
                },
                ...
                init: function () {
                    ...
                    appevents.addListener("on-remove-contact", this.remove_byname);
                ...
                onTextMessage: function (data) {
                    try {
                        if (data.sender == viewModel.selected_contact_name && appsrvc.currentview == "contact-chat") {
                            return;
                        }
