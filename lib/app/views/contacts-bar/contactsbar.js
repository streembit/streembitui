...
(function () {
    ...
    define(['knockout', 'appsrvc', 'contacts', 'contactlist', 'appevents', './contactsbar.html!text'], function (ko, appsrvc, contacts_handler, contactlist, appevents,  template) {
        ...
        function ContactsListVm() {
            ...
            // lookup the contacts on the network
            contacts_handler.init();
