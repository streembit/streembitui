...
(function () {
    ...
    define(
        ['appsrvc', 'contactlist', 'connections', 'uuid', 'peercomm', 'appevents', 'apputils', 'secure-random', 'settings', 'definitions', 'peermsg', 'contactsutil', 'uihandler', 'utilities', './contactsbar.html!text'],
        function (appsrvc, contactlist, connections, uuid, peercomm, appevents, apputils, secrand, settings, defs, peermsg, contactsutil, uihandler, utilities, template) {
