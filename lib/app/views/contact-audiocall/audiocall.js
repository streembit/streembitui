...
(function () {
    define(
        [
            ...
            'webrtccall', 'webrtcdata', 'filesender', 'uuid', 'secure-random', 'connections', 'database', './audiocall.html!text'
        ],
        function (
            appevents, contactlist, peercomm, appsrvc, defs, utilities,
            webrtccall, webrtcdata, filesender, uuid, secrand, connections, database, template) {
