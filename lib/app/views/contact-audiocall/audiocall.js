    ...
    define(
        ...
        function (
            ...
            function showChatControl() {
                ...
                $('.chat-fill-area').css({ height: ($('.content-panel').height() - 260), 'width': '84%', 'float': 'right' });
                $('.add-audio-call').css({'top': '205px', 'left': '6%'});
                $('.footer-chat-controls').css({'width': '86%', 'float': 'right'});
                $(".chat_items").show();
                $(function () {
