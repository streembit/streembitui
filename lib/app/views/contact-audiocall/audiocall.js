            ...
            function AudioCallVM(params) {
                var viewModel = {
                    ...
                    init: function () {
                        ...
                        var top = $('.forShowChatPos').first().height() + $('.forShowChatPos').first().offset().top - 80;
                        $('.add-audio-call.changeplace').css({'display': 'block'});
                        $('.add-audio-call').css({"top": top});
                        $(function () {
                            $(window).on('resize', function () {
                                $('.chat-fill-area').css({ height: ($('.content-panel').height() - 260) });
                                var top = $('.forShowChatPos').first().height() + $('.forShowChatPos').first().offset().top - 60;
                                $('.add-audio-call').css({"top": top});
                            })
                        });
