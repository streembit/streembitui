        ...
        function (
            ...
            function AudioCallVM(params) {
                var viewModel = {
                    ...
                    onPeerHangup: function (sender) {
                        //viewModel.peerhangup = true;
                        //webrtccall.hangup();

                        const patree = groupcall.participants.filter(p => p.name === sender);
                        groupcall.hangupCall(patree);
                    ...
                    updateGroupCall: function (setts) {
                        ...
                        //if (typeof setts.attendees !== 'undefined') {
                        //    groupcall.participants = setts.attendees;
                        //}
                    },
                    ...
                    addToGroupCall(payload) {
                        ...
                        // if (peercomm.is_peer_session(payload.attendee.name)) {
                        //     webrtccall.initcall(null, null, options, err => {
                        //         if (err) {
