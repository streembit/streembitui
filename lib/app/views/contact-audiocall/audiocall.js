                ...
                var viewModel = {
                    ...
                    hangup: function () {
                        ...
                        $.each(contactlist.contacts, (idx, item) => {
                            $('.all-contacts-field .list-group-item').eq(idx).removeClass('selected');
                        })
                    ...
                    show_invite: function () {
                        $('.inviteCont').toggleClass('activePanel');
                      
                        $.each(contactlist.contacts, (idx, item) => {
                            var contactL = $('.all-contacts-field .list-group-item');
                            ...
                            var vm = { 
                                inviteContact: function(){ 
                                    ...
                                    $('.forAddingContact [data-action="contactsBar"]').trigger('click');
                                    $('.inviteCont').removeClass('activePanel');
                        ...
                        if(!$('.inviteCont').hasClass('activePanel')){
                            $('.addUserIcon').remove();
                        }
                    ...
                    onTextMessage: function (event, msg, type = null, contact = null) {
                        if (msg.sender === viewModel.contact.name) {
