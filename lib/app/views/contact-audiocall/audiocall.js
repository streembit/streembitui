    ...
    define(
        ...
        function (
            ...
            function showChatControl() {
                ...
                $('.chat-fill-area').css({ height: ($('.view-content').height() - 260), 'width': '100%'});
                ...
                $(function () {
                    $(window).on('resize', function () {
                        $('.chat-fill-area').css({ height: ($('.view-content').height() - 260) });
                    })
                });
            }
            ...
            function AudioCallVM(params) {
                var viewModel = {
                    ...
                    init: function () {
                        ...
                        setTimeout(() => {
                            const activeAu = $('.forShowChatPos > div');
                    ...
                    sendfile: function () {
                        ...
                        try {
                            var recipients = [];
                            var callDivName = $('.forShowChatPos .user-name-div');
