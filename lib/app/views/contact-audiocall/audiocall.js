            ...
            function AudioCallVM(params) {
                var viewModel = {
                                    ...
                                    .then(
                                        function () {
                                            ...
                                            connections.create(item, true, taskid, function(err, webrtcconn) {
                                                ...
                                                viewModel.webrtcconn[item.pubkeyhash].send(peermsg);
                                            });
                                        },
                                        function (err) {
                                            throw new Error(err);
                    ...
                    addAttendee: function (attendee) {
                        ...
                        const audio_parent = $('.remoteaudio_parent');
                        const audio_html = audio_parent.find('div').eq(0).outerHTML;
                        audio_parent.append(audio_html);
