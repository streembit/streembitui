    ...
    define(['i18next', 'appevents', 'settings','./help.html!text'], function ( i18next, appevents, settings, template) {
        function HelpViewModel(params) {
            ...
            this.init = function(){
                ...
                var components = ['whatstreembitui_', 'opensource_', 'systemarchitecture_', 'security_', 'internetdevices_', 'settings_', 'configure_', 'createaccount_', 'backupaccount_', 'restoreaccount_', 'deleteaccount_', 'logfiles_', 'connectpublic_', 'connectprivate_', 'sharekeys_', 'cleardatabase_'];
