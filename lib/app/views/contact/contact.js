...
(function () {
    define(
        [
            ...
            'uihandler', 'filesender', 'utilities', 'contactlist', './contact.html!text'
        ],
        function (
            appevents, peercomm, appsrvc, defs, connections, screenshare, uuid, webrtcscreen,
            uihandler, filesender, utilities, contactlist, template) {
        ...
        function ContactVM(params) {
            ...
            var viewModel = {
                ...
                lastpingTime: ko.observable(params.lastping ? new Date(params.lastping).toLocaleTimeString() : "Not pinged"),
