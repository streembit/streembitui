...
(function () {
    define(
        ['appevents', 'contactlist', 'peercomm', 'appsrvc', 'definitions', 'utilities', 'connections', 'filesender', 'makeusabrew/bootbox', './contactchat.html!text'],
        function (appevents, contactlist, peercomm, appsrvc, defs, utilities, connections, filesender, bootbox, template) {
