...
(function () {
    define(
        ['appevents', 'contactlist', 'peercomm', 'peermsg', 'appsrvc', 'definitions',
         'utilities', 'connections', 'filesender', 'database', './contactchat.html!text'],
        function (
            appevents, contactlist, peercomm, peermsg, appsrvc, defs, utilities, connections, filesender, database, template) {
            ...
            var viewModel = {
                ...
                init: function () {console.log(viewModel.contact)
                    try {
                ...
                savechat: function () {
                    const data = {
                        ...
                        chat: peermsg.aes256encrypt(appsrvc.datacryptkey, JSON.stringify(this.chatitems()))
                    };
