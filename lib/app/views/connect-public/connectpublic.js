...
(function () {
    ...
    define(
        ['i18next', 'appevents', 'user', 'peercomm', 'appsrvc', 'definitions', 'uihandler', 'accounts', 'streembitnet', './connectpublic.html!text'],
        function (i18next, appevents, user, peercomm, appsrvc, defs, uihandler, accounts, streembitnet, template) {
        ...
        function ConnectPublicVm(params) {
            ...
            this.restore_account = function () {
                appevents.navigate("createaccount", { mode: 'restore' });
            };
