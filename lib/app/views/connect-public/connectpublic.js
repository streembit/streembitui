...
(function () {
    ...
    define(
        ['i18next', 'appevents', 'user', 'peercomm', 'appsrvc', 'definitions', 'uihandler', 'accounts', 'streembitnet', 'session', './connectpublic.html!text'],
        function (i18next, appevents, user, peercomm, appsrvc, defs, uihandler, accounts, streembitnet, session, template) {
