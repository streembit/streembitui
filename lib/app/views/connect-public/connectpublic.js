...
(function () {
    ...
    define(
        ['knockout', 'i18next', 'appevents', 'user', 'peercomm', 'appsrvc', 'definitions', 'uihandler', 'accounts', './connectpublic.html!text'],
        function (ko, i18next, appevents, user, peercomm, appsrvc, defs, uihandler, accounts, template) {
                ...
                try {
                    ...
                    peercomm.publish_user(public_key, transport, address, port, type, function (err) {
                        if (err) {
                            ...
                            streembit.notify.success("The account has been initialized on the Streembit network.");
