...
(function () {
    ...
    define(
        ['i18next', 'appevents', 'apputils', 'user', 'appsrvc', 'definitions', 'uihandler', 'accounts', './connectpublic.html!text'],
        function (i18next, appevents, apputils, user, appsrvc, defs, uihandler, accounts, template) {
