...
(function () {
    ...
    define(['knockout', 'settings', 'logger', './settings.html!text'], function (ko, settings, logger, template) {
            ...
            var viewModel = {
                ...
                add_bootseed: function () {
                    ...
                    if (!seed_host || !seed_port || !seed_publickey || isNaN(parseInt(seed_port))) {
                        return streembit.notify.error("Invalid seed data. The host IP address or domain name, port and public key are required.");
                    }
