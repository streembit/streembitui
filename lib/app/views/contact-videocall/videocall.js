...
(function () {
    define(
        [
            ...
            'webrtccall', 'uuid', 'connections', 'filesender', './videocall.html!text'],
        function (
            appevents, contactlist, peercomm, appsrvc, defs, utilities, webrtccall, uuid, connections, filesender, template) {
