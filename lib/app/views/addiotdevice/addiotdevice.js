...
(function () {
    define(['appevents', 'database', 'logger', 'definitions', './view.html!text'], function (appevents, database, logger, defs, template) {
        ...
        //function AddIotDeviceVM(params) {

        //    var viewModel = {
        //        gatewayid: params.id,
        //        newid: ko.observable(''),
        //        is_newid_error: ko.observable(false),
        //        iderror_text: ko.observable('This field is required.'),
        //        newname: ko.observable(''),
        //        is_newname_error: ko.observable(false),
        //        selected_newnetwork: ko.observable(''),
        //        is_selected_newnetwork_error: ko.observable(false),
        //        features: ko.observableArray([]),
        //        completefn: params.on_new_device,
        //        gatewaydata: params.data,
        //        selected_feature: ko.observable(0),
        //        parenthub: params,
        ...
        //        delete_feature: function (item) {
        //            this.features.remove(function (obj) {
        //                return obj.type == item.type;
        //            }) 
        //        },
        ...
        //            try {
        //                var device = { id: 0, name: "", gateway: this.id, type: 2, fautures: [] }; // type 2 = end device, type 1 = gateway
