...
(function () {
    ...
    define(
        ['appsrvc', 'streembitnet', 'settings', './netinfo.html!text'],
        function ( appsrvc, streembitnet, settings, template) {
            ...
            function NetInfoVm(params) {
                ...
                this.wshub = ko.observable('ws://' + appsrvc.wshost + ":" + appsrvc.wsport);
