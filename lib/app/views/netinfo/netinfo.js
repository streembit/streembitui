...
(function () {
    ...
    define(
        ['knockout', 'user', 'appsrvc', 'streembitnet', 'settings', './netinfo.html!text'],
        function (ko, user, appsrvc, streembitnet, settings, template) {
        ...
        function NetInfoVm(params) {
            ...
            this.iswspublish = ko.observable(appsrvc.wspublish ? 'YES' : 'NO');
