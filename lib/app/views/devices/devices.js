                    ...
                    this.send(message, (err, response) => {
                        try {
                            ...
                            if (!devicelist || !Array.isArray(devicelist) || !devicelist.length) {
                                throw new Error("invalid device list was sent ny the Hub");
                            }
            ...
            enable_gateway_join() {
                try {
                    ...
                    if (interval < 30 || interval > 300) {
                        return streembit.notify.error("Invalid join interval. The value must be between 30 and 300 seconds");
                    }
