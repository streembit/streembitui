...
(function () {
    define(['appevents', 'database', 'logger', 'definitions', 'async', 'errhandler', 'errcodes', './view.html!text'], function (appevents, database, logger, defs, async, errhandler, errcodes, template) {
