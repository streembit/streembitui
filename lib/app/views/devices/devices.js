    ...
    define(['appevents', 'database', 'logger', 'definitions', './view.html!text'], function (appevents, database, logger, defs, template) {
        ...
        class Device {
            constructor(data) {
                ...
                this.param2 = ko.observable();
                this.param3 = ko.observable();
                this.param4 = ko.observable();
                this.param5 = ko.observable();
                this.param6 = ko.observable();
                this.param7 = ko.observable();
                this.param8 = ko.observable();
            }          
