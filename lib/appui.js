...
function MainVM() {
    ...
    function navigate(page, params) {
        ...
        switch(navroute.page) {
            case 'audio-call':
                ...
                window.callData = params.contact.name;
                $main.hide();
                $call.show();
                navroute.page = 'emptyview';
                break;
            default:
                if(params !== 'fromContact') {
                    $main.show();
                    $call.hide();
                }
        ...
        if(page === 'emptyview' && window.callData) {
            page = 'audio-call';
        }
    ...
    var viewModel = {
        ...
        call: ko.observable({ page: 'emptyview', params: {} }),
