...
REM %ZIP_EXE% a -tzip %NWPACK_PATH% package.json ..\index.html ..\config.json  ..\assets ..\node_modules

%ZIP_EXE% a -tzip %NWPACK_PATH% package.json ..\config.js ..\streembit.html ..\config.json  ..\lib ..\node_modules ..\jspm_packages
